...
public class StudentLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Student Login.gif"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(102, 0, 204));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Enter Student ID.gif"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            {
                String qry = "select stuid from tbstudent where stuid = '" + sid + "'";
                ResultSet rs = new DB().execute(qry);
                if(rs.next())
                {
                    JOptionPane.showMessageDialog(null,"Welcome Student");
                    MainStudent obj = new MainStudent(sid);
                    obj.setVisible(true);
                    obj.pack();
                    this.dispose();
                }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        ForgotStudent obj = new ForgotStudent();
        obj.setVisible(true);
        obj.pack();
        this.dispose();
