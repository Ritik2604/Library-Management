 ...
 * @author Lovish
 */
public class SearchBookT extends javax.swing.JFrame {

    /**
     * Creates new form SearchBookT
     */
    public SearchBookT() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/SearchBookT.gif"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            String btit = jTextField1.getText();
            if(btit.equals(""))
            {
            ...
            {
                String qry = "select * from tbbook where booktit = '" + btit + "'";
